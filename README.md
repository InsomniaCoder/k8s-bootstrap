...
Built on top of https://github.com/aws-ia/terraform-aws-eks-blueprints and add the opinionated solution using ArgoCD to install a functioning Kubernetes cluster
